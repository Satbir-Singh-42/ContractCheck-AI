  ...
  return (
    <section className="pt-20 sm:pt-28 lg:pt-32 pb-14 sm:pb-20 lg:pb-24 flex flex-col items-center text-center relative overflow-visible">
      ...
      <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.45, delay: 0.2, ease: "easeOut" }} className="text-lg sm:text-xl md:text-2xl text-slate-400 max-w-[800px] mb-6 leading-relaxed px-4 font-light">
        ...
        designed to detect legal risk, non-compliance, and ambiguity in real contracts.
      </motion.p>
    </section>
  );
}
        ...
        <div className="bg-[#0B0B0E] border border-white/[0.08] rounded-3xl p-8 sm:p-12 md:p-16 flex flex-col md:flex-row items-center gap-10 sm:gap-16 overflow-hidden relative shadow-[0_0_50px_rgba(0,0,0,0.4)]">
          ...
          <div className="relative z-10 flex-1 flex flex-col gap-8 md:pl-10 lg:border-l border-white/[0.08]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/signup" className="flex items-center justify-center gap-2.5 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-bold transition-[background-color,box-shadow] duration-300 shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:shadow-[0_0_40px_rgba(37,99,235,0.6)] w-full sm:w-auto whitespace-nowrap">
                <Upload size={22} /> Start Analyzing Free
              </Link>
              <Link to="/pricing" className="flex items-center justify-center gap-2.5 px-8 py-4 rounded-xl font-bold text-white border border-white/20 hover:bg-white/10 hover:border-white/30 transition-colors duration-300 w-full sm:w-auto whitespace-nowrap">
